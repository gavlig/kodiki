...
// #[derive(SystemParam)]
// struct TextSpawnParams {
// 	pub glyph_meshes_cache,
// 	pub text_meshes_cache,
// 	pub color_materials_cache,
// 	pub emoji_materials_cache,
...
// TODO: maybe use struct with #[derive(SystemParam)] for text generation
pub fn spawn_words(
	(
		mut surfaces_bevy,
