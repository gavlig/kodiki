...
impl EditorViewBevy {
    ...
    pub fn render_view_single_layer(
        &self,
        editor: &Editor,
        doc: &Document,
        view: &View,
                ...
                (Mode::Insert, Mode::Normal) => {
                    ...
                    cxt.jobs.callback(async {
                        let call: job::Callback = Box::new(|_editor, compositor| {
                            compositor.remove(helix_term::ui::lsp::SignatureHelp::ID);
                        });
                        Ok(call)
                    });
                }
    ...
    pub fn handle_idle_timeout(&mut self, cx: &mut Context) -> EventResult {
        ...
        commands::insert::idle_completion(&mut cx);
...
impl Component for EditorViewBevy {
    ...
    fn render(&mut self, area: Rect, surface: &mut Surface, cx: &mut Context) {
        ...
        for (view, is_focused) in cx.editor.tree.views() {
            ...
            self.render_view_single_layer(cx.editor, doc, view, area, surface, is_focused);
        }
